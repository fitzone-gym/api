  ...
  `;
      ...
      connection.query(deleteQuery, [doctorId], (err, result) => {
        ...
        if (err) {
          ...
          return res
            .status(500)
            .json(generateResponse(false, null, "Error deleting doctor"));
        }
        ...
        if (result) {
          res
            .status(200)
            .json(generateResponse(true, "Doctor deleted successfully"));
        } else {
          res
            .status(404)
...
export const addDoctor = (req: Request, res: Response) => {
  ...
  try {
      ...
      connection.query(
        ...
        (err, result) => {
          if (err) {
            ...
            return res
              .status(500)
              .json(generateResponse(false, null, "Error adding doctor"));
          }
    ...
    res.status(500).json(generateResponse(false, null, "Error adding doctor"));
  }
};
