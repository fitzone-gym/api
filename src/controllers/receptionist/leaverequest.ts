...
export const getleaverequestDetails = async (req: Request, res: Response) => {
  try {
    ...
    const query =
      "SELECT * FROM receptionist_leave_request ORDER BY acceptance_status, requested_date ";
...
export const createLeaveRequest = async (req: Request, res: Response) => {
  try {
    ...
    const query = "INSERT INTO receptionist_leave_request (requested_date, from_date, to_date, reason, acceptance_status) values (?,?,?,?,0)";
